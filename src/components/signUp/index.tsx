...
import { setCredentials } from '../../reduxStore/reducer/authSlice'
import { useLoginMutation } from '../../reduxStore/reducer/authApiSlice'
import { useNavigate } from 'react-router-dom';
import type { RootState } from '../../reduxStore/store'
import logoLight from '../../assets/images/VerySmarLight.svg'
...
const SignUp = () => {
    ...
    const onSubmit: SubmitHandler<IFormInput> =async(data) => {
            ...
            try {
                ...
                const accessToken=userData.data[0].token 
            ...
            <div className='WholeContainer-wrapper mx-auto  shadow-lg' >
                <div className={`formContainer sign-in-container ${toggle ? 'sign-in-container-right-active' : ''} `}>
                 ...
                 {/* <div className="svgContainer">
                    <div>
                        <svg className="mySVG" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                            <defs>
                        ...
                        <FloatingLabel
                          ...
                          >
                             <Controller
                                    ...
                                    control={control}
                                    defaultValue=""
                                    render={({ field }) => <Form.Control {...field} type="email" id='email' placeholder="email" />}
                                />
                        ...
                        <Controller
                                    ...
                                    control={control}
                                    defaultValue=""
                                    render={({ field }) => <Form.Control {...field} type="password" id='password' placeholder="Password" />}
                                />
                        </FloatingLabel>
                ...
                <div className={`overlay-container ${toggle ? 'overlay-container-right-active' : ''}`}>
                    ...
                    <div className={`overlay ${toggle ? 'overlay-right-active' : ''}`}>
                        <div className={`overlay-panel overlay-left ${toggle ? 'overlay-left-right-active' : ''}`}>
                            <div><img width={200} height={40} alt="VerySmart" src={logoLight}></img></div>
                            <h1>Welcome Back!</h1>
                            <p>
                        ...
                        <div className={`overlay-panel overlay-right  ${toggle ? 'overlay-right-right-active' : ''}`}>
                            <h1><img width={250} height={40} alt="VerySmart" src={logoLight}></img></h1>
